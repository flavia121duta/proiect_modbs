-- tabela PRODUS trebuie sa se gaseasca in ambele scheme
-- bdd_bucuresti si bdd_provincie
-- facem replicare
create table produs_provincie as
select *
from produs@bd_all;
/
...
-- bdd_bucuresti si bdd_provincie
-- facem replicare
create table materie_prima_provincie as
select *
...
-- bdd_bucuresti si bdd_provincie
-- facem replicare
create table produs_materie_prima_provincie as
select *
